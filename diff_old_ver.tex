...
%DIF DEL tmp2.tex   Tue Sep  1 21:20:24 2026
%DIF ADD tmp1.tex   Tue Sep  1 21:20:24 2026
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %DIF > 
...
Section~\ref{sec:val} }\DIFaddend presents a real-time implementation of CONAC on a 2-DOF robotic manipulator\DIFaddbegin \DIFadd{, and compares it with existing methods with discussions on advantages and limitations of CONAC}\DIFaddend .
...
%DIF <  \includegraphics[width=\figSizeOneCol\linewidth]
        %DIFDELCMD < {
%DIFDELCMD <             %%%
\DIFdelFL{src/figures/expSet.drawio.png
        }%DIFDELCMD < }%%%
%DIF < 
    %DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD <     }
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.99\linewidth]{figs/expSet.drawio.png}%
...
\centering
  ...
  \includegraphics[width=.89\linewidth]{figs/saturation_cmp.drawio.pdf}%
