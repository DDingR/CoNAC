...
% SAVE_FLAG = 1;
SAVE_FLAG = 1;
POSITION_FLAG = 0; % it will plot fiugures in the same position
...
plot_control(ctrl2_rep, POSITION_FLAG, 1);

figure(7); clf; tl = tiledlayout(2, 1);
plot_control(ctrl3_rep, POSITION_FLAG, 1);

figure(8); clf; tl = tiledlayout(2, 1);
plot_control(ctrl4_rep, POSITION_FLAG, 1);

%% FIGURE 3: WEIGHT BALL
figure(9); clf
plot_weight_norm(ctrl1_rep, POSITION_FLAG, 2);

figure(10); clf
plot_weight_norm(ctrl2_rep, POSITION_FLAG, 2);

figure(11); clf
plot_weight_norm(ctrl3_rep, POSITION_FLAG, 2);

figure(12); clf
plot_weight_norm(ctrl4_rep, POSITION_FLAG, 2);

%% FIGURE 4: MULTIPLIERS
figure(13); clf
plot_multipliers(ctrl1_rep, POSITION_FLAG);
